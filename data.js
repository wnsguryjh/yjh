...
window.PORTFOLIO_DATA = {
  ...
  about: {
    ...
    quote: {
      ko: "저는 단순한 관리가 아닌, 운영 효율과 재무 성과, 그리고구성원 경험을 동시에 끌어올리는 총무 전문가입니다.",
    ...
    paragraphs: {
      ko: [
        ...
        "검토와 보고서 작성에 LLM, 시장 조사에 Perplexity와 Chat GPT, 시각화에 Claude와 Napkin, 그리고 직접 만든 운영 대시보드까지 — 총무의 전 주기를 AI로 다시 설계하고 있습니다. 안정적이고 효율적인 경영지원 체계를 함께 구현할 자리를 찾고 있습니다."
      ],
      en: [
  ...
  career: [
    {
      ...
      bullets: {
        ...
        en: [
          ...
          "Authored / amended 5+ policies · introduced multiple processes",
    ...
    },
    {
      ...
      bullets: {
        ko: [
          ...
          "SW 라이선스 구매 — Adobe · Figma · Axure · Zeplin · JetBrains · Office 등",
  ...
  projects: [
    ...
    },
    {
      ...
      summary: {
        ko: "500명 규모의 좌석·회의실·동선을 설계. 부서별 협업 패턴을 동시에 반영한 스마트 오피스.",
    ...
    },
    {
      ...
      tags: { ko: ["이전", "공간설계", "방역"], en: ["Relocation PM", "Space", "Sanitation"] }
    },
    {
      id: "p05",
      year: "2024",
    ...
    },
    {
      ...
      year: "2023~ING",
      category: "ops",
      title: { ko: "5개 계열사 행사,복지 통합 운영", en: "Affiliate-Wide Year-End Event PM" },
      org: "KONA I",
